...
func TestNewYorkTimesScraper_ScrapeArticle_Title(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
...
func TestNewYorkTimesScraper_ScrapeArticle_FullArticle(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeArticle_BodyParagraphs(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeArticle_OnlyBodyContent(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
	...
	if !strings.Contains(result, "This should appear") {
		t.Error("content from article-content-container should be included")
	}
}

func TestNewYorkTimesScraper_ScrapeArticle_EmptyContent(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeArticle_InvalidURL(t *testing.T) {
	scraper := &NewYorkTimesScraper{}
...
func TestNewYorkTimesScraper_ScrapeArticle_NoTitle(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeArticle_MultipleH1(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeArticle_ContentOrder(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
	...
	if titleIdx >= bodyIdx {
		t.Error("title should appear before body")
	}
}

func TestNewYorkTimesScraper_ScrapeTitle_Basic(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
	<h1>NYT Article Title</h1>
	<div class="article-content-container"></div>
</body>
</html>`
	...
	expected := "NYT Article Title"
	if result != expected {
		t.Errorf("ScrapeTitle() = %q, want %q", result, expected)
	}
}

func TestNewYorkTimesScraper_ScrapeTitle_WithWhitespace(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeTitle_WithNewlines(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeTitle_NoH1(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeTitle_MultipleH1(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeTitle_EmptyH1(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeTitle_InvalidURL(t *testing.T) {
	scraper := &NewYorkTimesScraper{}
...
func TestNewYorkTimesScraper_ScrapeTitle_SpecialCharacters(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeTitle_WithNestedElements(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeTitle_UnicodeCharacters(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_Basic(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_ConvertsToLowercase(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_ReplacesSpacesWithUnderscores(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_ReplacesDoubleUnderscores(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_EmptyTitle(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_NoH1(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_InvalidURL(t *testing.T) {
	scraper := &NewYorkTimesScraper{}
...
func TestNewYorkTimesScraper_ScrapeFilename_SingleWord(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_PreservesSpecialCharacters(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
...
func TestNewYorkTimesScraper_ScrapeFilename_UnicodeCharacters(t *testing.T) {
	html := `<!DOCTYPE html>
<html>
<head><title>Test</title></head>
<body>
